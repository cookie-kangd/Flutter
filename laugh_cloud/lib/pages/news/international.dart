...
class InternationalScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new _InternationalScreenState();
  }
}

class _InternationalScreenState extends State<InternationalScreen> with AutomaticKeepAliveClientMixin {
  @override
  ...
  void getData() async {
    //初始数据源
    var url = 'https://pacaio.match.qq.com/irs/rcd?cid=56&ext=world&token=c786875b8e04da17b24ea5e332745e0f&num=20&expIds=20190106A13PFT%7C20190108A04MLS&page='+_mPage.toString();
    Response response;
    var dio = new Dio();
